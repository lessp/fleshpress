        ...
        */
        ...
        ) 
        {
            ...
            try {
                ...
                // TODO: $idDenominator would have to be used with caution
                //       since it may open up for SQL-injections
                //       figure out a better approach, without affecting
                //       usability too much.
                $sql = (
        ...
        {
            try {
                $sql = 'DELETE FROM ' . static::$tableName . ' WHERE :idDenominator = :id LIMIT 1';
                $statement = self::getDB()->prepare($sql);
                
                $statement->bindValue(':idDenominator', $idDenominator);
                $statement->bindValue(':id', $id);
                $statement->execute();
